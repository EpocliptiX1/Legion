...
document.addEventListener('DOMContentLoaded', function() {
    ...
    watchNowBtn.addEventListener('click', async function() {
        ...
        */
        ...
        // this codebase has no way to check in advance or predict. See Backend/server.js's own
        // comment where /api/anime-pahe-embed used to live, and
        // investigation-t1m-megaplay-2026-09-07.md's two 2026-09-09 follow-ups, for the full
        // trail.
