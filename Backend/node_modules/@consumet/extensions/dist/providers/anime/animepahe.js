...
class AnimePahe extends models_1.AnimeParser {
    constructor() {
	    ...
	    console.log(`${this.baseUrl}/api?m=search&q=${encodeURIComponent(query)}`);
            try {
	...
	Headers(sessionId) {
	    return {
        	cookie: `cf_clearance=EAvYn.YCDqi0b_fulnLOZtLTNnIuolI1o0DaZq.YVGc-1781701611-1.2.1.1-8LEJef3gsXU94u.Fpe2_gLlyfL2xmiugYv21SYKlhKEXScMXFhHFYZl9doxTs3Kv3IALoofgw0EGCU6Au9IehKfK4pcjkJF.VoSjmwEC.DGjCgQ49qNBydv23LSlUIKm3_yaUmm_gO7CEeata6ytElSrHIypMBcIcG1Hv_K3KpNCUI9RnBiyVwlvxFf4ZOUS8mmRmrYRLkrR722AZKX26P4ONcW_Kx2dPcgWrhr512Pqzy60XIhfFYeenJ2_R5gFGtFhKUlHIOqQq4JOCJwVechZD.yAe9sEmn6b.93yj7chg4gEWgrGj0pM6rjZrV63dGMjtMWB3lUn3hT2RJocM7gYBMzQ4RIJ5LMla3zP2sbVLz.NaWbd_HGL.zsH9hOM97MXkEsOt63fOqOWRZrfeNWCFVOwbYqzW1drHOH2c0o4mWHHu_HEUMzevdx56MSy`,
        	referer: sessionId
        	    ? `${this.baseUrl}/anime/${sessionId}`
        	    : this.baseUrl,
        	'user-agent':
        	    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/148.0.0.0 Safari/537.36 OPR/132.0.5905.28'
    	};}
}
